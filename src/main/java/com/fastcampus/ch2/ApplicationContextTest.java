...
//설정 클래스
@Configuration
@ComponentScan(basePackages = "com.fastcampus.ch2")
class AppConfig {}

public class ApplicationContextTest {
    public static void main(String[] args) {
    	//1. AC 생성 - 설정 파일 지정. 
        //ApplicationContext ac = new GenericXmlApplicationContext("config.xml"); //수동주입.
        AnnotationConfigApplicationContext ac = new AnnotationConfigApplicationContext(AppConfig.class); //자동주입.
        
        //2. AC(빈 컨테이너)에서 빈 가져오기. 
